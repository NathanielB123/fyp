...
⟦,>eq⟧ : ∀ ⟦Γ⟧ → ⟦Tm⟧ ⟦Γ⟧ ⟦𝔹⟧ → Bool → ⟦Ctx⟧
⟦,>eq⟧ ⟦Γ⟧ ⟦t⟧ b = Σ ⟦Γ⟧ (λ ρ → Box (⟦t⟧ ρ ≡ᴾ b))
...
⟦ Γ ▷ t >eq b ⟧Ctx = Σ⟨ ρ ∶ ⟦ Γ ⟧Ctx ⟩× Box (⟦ t ⟧Tm ρ ≡[ Ty≡-inst ⟦𝔹⟧′ ]≡ᴾ b)
...
hmm : ⟦Π⟧ ⟦A₁⟧ ⟦B₁⟧ ≡ᴾ ⟦Π⟧ ⟦A₂⟧ ⟦B₂⟧ → ⟦A₁⟧ ≡ ⟦A₂⟧
hmm p = {!!}

-- hmm : Ty~ rfl~ (Π A₁ B₁) (Π A₂ B₂) → ⟦ A₁ ⟧Ty ≡ᴾ ⟦ A₂ ⟧Ty
-- hmm {A₁ = A₁} A~ = {!!}