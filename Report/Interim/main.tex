...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Conid{SN}\;\mathrel{=}\;\Varid{∀}\;\Varid{t}\;\Varid{→}\;\Conid{Acc}\;\Varid{\char95 →β\char95 }\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\[\blanklineskip]%
\>[3]{}\Conid{SN-classical}\;\mathrel{=}\;\Varid{∀}\;\Varid{t}\;\Varid{→}\;\Varid{¬}\;\Varid{∞Chain}\;\Varid{\char95 →β\char95 }\;\Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{} \;\Conid{Ctx}\;\mathbin{:}\;\Keyword{Type}{}\<[E]%
\\
\>[B]{} \;\Conid{Ty}\;{}\<[10]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{suⁱ}\;\mathrel{=}\;\Varid{λ}\;(\Varid{suᵉ}\;(\texttt{\textasciigrave}\;\Varid{vz})){}\<[E]%
\\
\>[B]{}\Varid{suᵉ}\;\Varid{n}\;\mathrel{=}\;\Varid{suⁱ}\;\Varid{·}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{} \;\Conid{Tms[\char95 ]}\;(\Varid{q}\;\mathbin{:}\;\Conid{Sort})\;\mathbin{:}\;\Conid{Ctx}\;\Varid{→}\;\Conid{Ctx}\;\Varid{→}\;\Keyword{Type}\;\Keyword{where}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{ε}\;{}\<[9]%
...
\\[\blanklineskip]%
\>[B]{}\Conid{Vars}\;\mathrel{=}\;\Conid{Tms[}\;\Conid{V}\;\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Conid{Tms}\;{}\<[6]%
\>[6]{}\mathrel{=}\;\Conid{Tms[}\;\Conid{T}\;\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{vz[\char95 ]}\;\mathbin{:}\;\Varid{∀}\;\Varid{q}\;\Varid{→}\;\Conid{Tm[}\;\Varid{q}\;\mskip1.5mu]\;(\Conid{Γ}\;\Varid{,}\;\Conid{A})\;\Conid{A}{}\<[E]%
\\
\>[B]{}\Varid{vz[}\;\Conid{V}\;\mskip1.5mu]\;\mathrel{=}\;\Varid{vz}{}\<[E]%
\\
\>[B]{}\Varid{vz[}\;\Conid{T}\;\mskip1.5mu]\;\mathrel{=}\;\texttt{\textasciigrave}\;\Varid{vz}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{suc[\char95 ]}\;\mathbin{:}\;\Varid{∀}\;\Varid{q}\;\Varid{→}\;\Conid{Tm[}\;\Varid{q}\;\mskip1.5mu]\;\Conid{Γ}\;\Conid{B}\;\Varid{→}\;\Conid{Tm[}\;\Varid{q}\;\mskip1.5mu]\;(\Conid{Γ}\;\Varid{,}\;\Conid{A})\;\Conid{B}{}\<[E]%
\\
\>[B]{}\Varid{\char95 ⁺\char95 }\;{}\<[8]%
\>[8]{}\mathbin{:}\;\Conid{Tms[}\;\Varid{q}\;\mskip1.5mu]\;\Conid{Δ}\;\Conid{Γ}\;\Varid{→}\;\Varid{∀}\;\Conid{A}\;\Varid{→}\;\Conid{Tms[}\;\Varid{q}\;\mskip1.5mu]\;(\Conid{Δ}\;\Varid{,}\;\Conid{A})\;\Conid{Γ}{}\<[E]%
\\
\>[B]{}\Varid{\char95 \char94 \char95 }\;{}\<[8]%
\>[8]{}\mathbin{:}\;\Conid{Tms[}\;\Varid{q}\;\mskip1.5mu]\;\Conid{Δ}\;\Conid{Γ}\;\Varid{→}\;\Varid{∀}\;\Conid{A}\;\Varid{→}\;\Conid{Tms[}\;\Varid{q}\;\mskip1.5mu]\;(\Conid{Δ}\;\Varid{,}\;\Conid{A})\;(\Conid{Γ}\;\Varid{,}\;\Conid{A}){}\<[E]%
\\
\>[B]{}\Varid{\char95 [\char95 ]}\;{}\<[8]%
...
\\[\blanklineskip]%
\>[B]{} \;\Varid{\char95 →!\char95 }\;\mathbin{:}\;\Conid{Tm}\;\Conid{Γ}\;\Conid{A}\;\Varid{→}\;\Conid{Tm}\;\Conid{Γ}\;\Conid{A}\;\Varid{→}\;\Keyword{Type}\;\Keyword{where}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{β}\;{}\<[13]%
\>[13]{}\mathbin{:}\;\Varid{∀}\;\{\mskip1.5mu \Varid{ƛt}\;\Varid{t[u]}\mskip1.5mu\}\;\Varid{→}\;\Varid{ƛt}\;\Varid{≡}\;\Varid{λ}\;\Varid{t}\;\Varid{→}\;\Varid{t[u]}\;\Varid{≡}\;\Varid{t}\;[\mskip1.5mu \;\Varid{<}\;\Varid{u}\;\Varid{>}\;\mskip1.5mu]\;\Varid{→}\;(\Varid{ƛt}\;\Varid{·}\;\Varid{u})\;\Varid{→!}\;\Varid{t[u]}{}\<[E]%
\\
\>[3]{}\Varid{rec-true}\;{}\<[13]%
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\Varid{rw}\;{}\<[13]%
\>[13]{}\mathbin{:}\;\Varid{¬}\;\Varid{t/f}\;\{\mskip1.5mu \Conid{A}\;\mathrel{=}\;\Conid{𝔹'}\mskip1.5mu\}\;\Varid{t}\;\Varid{→}\;\Varid{t/f}\;\{\mskip1.5mu \Conid{A}\;\mathrel{=}\;\Conid{𝔹'}\mskip1.5mu\}\;\Varid{u}\;\Varid{→}\;\Varid{t}\;\Varid{→!}\;\Varid{u}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[3]{}\mbox{\onelinecomment  l·     : t₁ [ q→ ]→ t₂ → (t₁ · u) [ q→ ]→ (t₂ · u) }{}\<[E]%
\\
\>[3]{}\mbox{\onelinecomment  ·r     : u₁ [ q→ ]→ u₂ → (t · u₁) [ q→ ]→ (t · u₂)}{}\<[E]%
\\
\>[3]{}\mbox{\onelinecomment  ƛ_     : t₁ [ q→ ]→ t₂ → (ƛ t₁)   [ q→ ]→ (ƛ t₂)}{}\<[E]%
\\
\>[3]{}\mbox{\onelinecomment  𝔹-rec₁ : t₁ [ q→ ]→ t₂ → 𝔹-rec t₁ u v [ q→ ]→ 𝔹-rec t₂ u v}{}\<[E]%
\\
\>[3]{}\mbox{\onelinecomment  𝔹-rec₂ : u₁ [ q→ ]→ u₂ → 𝔹-rec t u₁ v [ q→ ]→ 𝔹-rec t u₂ v}{}\<[E]%
\\
\>[3]{}\mbox{\onelinecomment  𝔹-rec₃ : v₁ [ q→ ]→ v₂ → 𝔹-rec t u v₁ [ q→ ]→ 𝔹-rec t u v₂}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
% ---------------------------------------------------------------------------- %
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{} \;\Conid{ℤ}\;\mathbin{:}\;\Keyword{Type}\;\Keyword{where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\>[16]{}\mathrel{=}\;\Varid{true}{}\<[E]%
\\
\>[B]{}\Varid{is-zero}\;(\Varid{su}\;\anonymous )\;\mathrel{=}\;\Varid{false}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[16]{}\mathrel{=}\;\Varid{inl}\;\Varid{tt}{}\<[E]%
\\
\>[B]{}\Varid{unfix-ℕ}\;(\Varid{su}\;\Varid{n})\;\mathrel{=}\;\Varid{inr}\;\Varid{n}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\Varid{ze}\;\Varid{→}\;\Keyword{let}\;\Varid{foo}\;\mathbin{:}\;\Varid{t}\;\Varid{≡}\;\Varid{ze}{}\<[E]%
\\
\>[3]{}\hsindent{9}{}\<[12]%
\>[12]{}\Varid{foo}\;\mathrel{=}\;\Varid{refl}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
